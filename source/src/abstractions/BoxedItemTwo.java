...
public class BoxedItemTwo implements InsurableItem {

    // this class is the same as BoxedItem class but it has multiple inheritance from three separate interfaces
        ...
        // constructor
        public BoxedItemTwo(String desc, int pric, int wght, boolean haz){
            this.descript = desc;
            this.price = pric;
            this.hazardous = haz;
            this.weight = wght;
